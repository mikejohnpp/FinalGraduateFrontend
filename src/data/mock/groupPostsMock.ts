...
export const groupPosts: GroupPost[] = [
  ...
  },
  {
    ...
    content:
      "Có ai đang dùng React 19 chưa ạ? Cho mình xin ít review về useActionState với. Cảm ơn mọi người!",
  ...
  },
  {
    ...
    authorName: "Vũ F",
    content:
      "Mình vừa viết một bài hướng dẫn chi tiết về Tailwind CSS v4, mời mọi người tham khảo nhé!",
    linkPreview: {
  ...
  },
  {
    ...
    authorName: "Bùi H",
    content:
      "Tìm chủ mới cho bé ALN màu silver này ạ. Bé được 2 tháng tuổi, ăn uống ngoan ngoãn, đi vệ sinh đúng chỗ.",
  ...
  },
  {
    ...
    authorName: "Ngô I",
    content:
      "Quán bún ốc này ngon thật sự mọi người ơi. Nước dùng thanh ngọt, ốc to giòn, lại còn có thêm chuối đậu nữa. Mình cho 9/10 nhé.",
    images: [

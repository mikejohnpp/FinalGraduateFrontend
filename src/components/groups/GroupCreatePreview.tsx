...
export default function GroupCreatePreview({ groupName, privacy, previewMode, onPreviewModeChange }: GroupCreatePreviewProps) {
  return (
      ...
      <Card className={cn(
        ...
        <div className="bg-background px-4 py-4 md:px-8">
          ...
          <div className="flex items-center gap-1.5 text-muted-foreground">
            ...
            <span className="font-medium">Nhóm {privacy === 'public' ? 'Công khai' : 'Riêng tư'}</span>
            <span>·</span>
          ...
          <div className="mt-4 flex items-center justify-between border-t pt-1">
            <Tabs defaultValue="about" className="w-full">
              <TabsList className="flex h-12 justify-start gap-2 bg-transparent p-0">
                <TabsTrigger value="about" className="h-full rounded-none px-4 font-semibold text-muted-foreground data-[state=active]:border-b-4 data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-primary data-[state=active]:shadow-none">
                  Giới thiệu
                </TabsTrigger>
                <TabsTrigger value="posts" className="h-full rounded-none px-4 font-semibold text-muted-foreground data-[state=active]:border-b-4 data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-primary data-[state=active]:shadow-none">
                  Bài viết
                </TabsTrigger>
                <TabsTrigger value="members" className="h-full rounded-none px-4 font-semibold text-muted-foreground data-[state=active]:border-b-4 data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-primary data-[state=active]:shadow-none">
                  Thành viên
                </TabsTrigger>
              </TabsList>
            </Tabs>
          ...
          <Card className="h-fit border-0 p-4 shadow-sm">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-3">
                {privacy === 'public' ? <Globe className="mt-1 size-6 opacity-70" /> : <Lock className="mt-1 size-6 opacity-70" />}
                <div>

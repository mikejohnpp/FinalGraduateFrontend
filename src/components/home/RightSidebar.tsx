...
export default function RightSidebar() {
  return (
    <aside className="hidden w-[300px] shrink-0 flex-col gap-2 overflow-y-auto py-4 pr-4 pl-2 lg:flex">
      ...
      <div className="flex flex-col gap-1 px-2">
        <span className="text-xs font-semibold text-muted-foreground">Liên hệ</span>
        {contacts.map((c) => (

...
export class ChatService extends BaseService {
  ...
  ): Promise<ApiResultGeneric<Conversation> | undefined> {
    try {
      return await http.post<ApiResultGeneric<Conversation>>(`chat/conversations`, {
        userOppenentId,
        userCurrentId,
      });
    } catch (e) {
  ...
  async createGroupConversation(
    ...
    try {
      ...
      return await http.post<ApiResultGeneric<Conversation>>(
  ...
  async getConversationDetail(
    ...
    page: number = 0,
    size: number = 50,
  ): Promise<ApiResultGeneric<any> | undefined> {
    try {
      return await http.get<ApiResultGeneric<any>>(
  ...
  async getConversationDetail2(
    ...
    try {
      ...
      return await http.get<ApiResultGeneric<any>>(url);
    } catch (e) {
      return Promise.reject(e);
    }
  }
